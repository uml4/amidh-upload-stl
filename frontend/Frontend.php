...
//        add_shortcode( 'ap-booking', array( $this->bookingController, 'renderShortCode' ) );
    ...
    public function linkAssets()
    {
        ...
        // Assets for [bookly-cancellation-confirmation].
        call_user_func( $link_script, 'bookly-cancellation-confirmation', plugins_url( 'modules/cancellation_confirmation/resources/js/cancellation_confirmation.js', __FILE__ ), array( 'jquery' ), $version );
