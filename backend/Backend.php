...
class Backend
{
    ...
    public function __construct()
    {
        ...
        $this->patientController         = Modules\PatientRecord\Controller::getInstance();
    ...
    public function addAdminMenu()
    {
        ...
        if ( $current_user->has_cap( 'administrator' ) || Lib\Entities\Staff::query()->where( 'wp_user_id', $current_user->ID )->count() ) {
            ...
            add_menu_page( 'Amidh', 'Amidh', 'read', 'bookly-menu', '',
...
//            } else {
                ...
                $patientRecord       = __( 'Patient Record',      'bookly' );
                ...
                add_submenu_page( 'bookly-menu', $patientRecord, $patientRecord, 'manage_options',
 Modules\PatientRecord\Controller::page_slug, array( $this->patientController, 'index' ) );
