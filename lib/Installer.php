...
//        );
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Message::getTableName() . '` (
              ...
              COLLATE = utf8_general_ci'
               ...
               $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\StaffCustomer::getTableName() . '` (
                `id`         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
                `staff_wp_id` BIGINT(20) UNSIGNED DEFAULT NULL,
       ...
       $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\StaffCustomerDetail::getTableName() . '` (
                `id`         INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
                `medical_id` BIGINT(20) UNSIGNED DEFAULT NULL,
                `image`  VARCHAR(500)  NULL DEFAULT "",
                `comment`      TEXT  NULL DEFAULT "",
                `created_date`   DATETIME DEFAULT NULL
            ) ENGINE = INNODB
            DEFAULT CHARACTER SET = utf8
